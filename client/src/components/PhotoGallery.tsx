...
const photos = [
  ...
  },
  {
    ...
    location: "Apuseni, România",
    caption: "Locuri mici, povești mari. Fiecare Tiny House ascunde o lume întreagă — și eu sunt aici să o arăt lumii.",
    likes: "189",
    size: "tall",
    account: "@amaliaontheroad",
  },
  {
    ...
    title: "Boutique Hotel Moments",
    location: "Europa",
    caption: "Detaliile fac diferența — o lumânare, o carte, o ceașcă de ceai. Asta este storytelling vizual.",
    likes: "243",
    size: "wide",
    account: "@amaliaontheroad",
  },
